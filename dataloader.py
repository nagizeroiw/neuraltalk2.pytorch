...
class DataLoader(data.Dataset):
    ...
    def get_batch(self, split, batch_size=None, seq_per_img=None):
        ...
        for i in range(batch_size):
            ...
            label_batch[i * seq_per_img: (i + 1) *
                        seq_per_img, 1: self.seq_length + 1] = seq
    ...
    def __getitem__(self, index):
        ...
        return get_npy_data(ix,
                            os.path.join(self.input_fc_dir, str(
                                self.info['images'][ix]['id']) + '.npy'),
                            os.path.join(self.input_att_dir, str(
                                self.info['images'][ix]['id']) + '.npz'),
                            self.use_att
                            )
